...
@bp.put("/api/swing-tracker/<int:trade_id>")
...
@bp.delete("/api/swing-tracker/<int:trade_id>")
...
@bp.post("/api/swing-tracker/<int:trade_id>/refresh-price")
...
@bp.post("/api/swing-tracker/refresh-all")
...
@bp.get("/api/swing-tracker/sources")
...
@bp.post("/api/swing-tracker/sources")
...
@bp.get("/api/swing-tracker/lookup-ticker")
